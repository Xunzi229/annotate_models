...
The schema comment looks like this:
    ...
    # Table name: articles
    #
    # id         :integer    ID         not null, primary key
    # title      :string     文章标题
    # content    :string     文章内容
    # created_at :datetime   文章创建时间     not null
    # updated_at :datetime   文章更新时间     not null
    #
Into Gemfile from Github:
    gem 'annotate', git: 'https://github.com/Xunzi229/annotate_models.git', require: false

== 原gemdoc Annotate (aka AnnotateModels)
